    ...
    module RouteSets
      ...
      def atrium_collections
        add_routes do |options|
          ...
          match 'atrium_collections/:collection_id/edit_filter' => 'catalog#index', :defaults=>{:edit_collection_filter=>true,:search_field=>'all_fields'}, :as=>'edit_atrium_collection_filter'
